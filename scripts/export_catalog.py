...
def export(database: Path, output: Path):
    ...
    for opportunity in opportunities:
        ...
        catalog.append(item)
    dump_json(output / "catalog.json", {"schema_version": "1.0.0", "opportunities": catalog})
    ...
    review = records(connection, """
        SELECT o.public_id AS Program_ID, o.program_name AS Program_Name, i.institution_name AS Host_Institution,
          ...
          o.application_url AS Application_URL, c.last_verified AS Last_Verified, c.data_confidence AS Data_Confidence,
